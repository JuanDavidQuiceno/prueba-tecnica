...
var schemaUpdateProducto = Joi.object({
...
var createProducto = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                error = schemaPostProducto.validate(req.body).error;
                if (error) {
...
var updateProducto = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                error = schemaUpdateProducto.validate(req.body).error;
                if (error) {
                    return [2 /*return*/, res.status(400).json({ error: error.details[0].message })];
                }
                _a.label = 1;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, typeorm_1.getRepository(producto_1.Producto).delete(req.params.id)];
            case 2:
